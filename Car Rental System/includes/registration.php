  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="background-color:#87CEEB; height:500px; overflow:auto;">
            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group checkbox">
                  ...
                  <label for="terms_agree" style="color:black;">I Agree with <a href="#" style="color:#0066b2;">Terms and Conditions</a></label>
                </div>
                <div class="form-group">
                  <input type="submit" value="Sign Up" name="signup" id="submit" class="btn btn-block" style="background-color:#0066b2;">
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="modal-footer text-center">
        <p> <a href="#loginform" data-toggle="modal" data-dismiss="modal" style="color:#0066b2;">Already got an account?</a></p>
      </div>
    </div>
  </div>
</div>
